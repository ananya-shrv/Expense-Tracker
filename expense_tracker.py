...
dataentry_frame_bg = '#%02x%02x%02x' % lavender

lilac = (200, 162, 200)
buttons_frame_bg = '#%02x%02x%02x' % lilac

pale_pink = (255, 228, 225)
hlb_btn_bg = '#%02x%02x%02x' % pale_pink


lbl_font = ('Helvetica', 13)
entry_font = ('Times New Roman', 13, 'bold')
btn_font = ('Gill Sans', 13)
...
Button(buttons_frame, text='Clear Fields in DataEntry', font=btn_font, width=25, bg=hlb_btn_bg,
...
Button(buttons_frame, text='View Chosen Expense\'s Details', font=btn_font, width=25, bg=hlb_btn_bg,
